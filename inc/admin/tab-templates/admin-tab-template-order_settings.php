				...
				<tbody>
					<tr>
						<th scope="row" class="titledesc">
							<a class="button-primary" href="<?php echo esc_url(get_site_url()); ?>?ns_manual_search_product=1">Sync Product's Internal ID's</a>
						</th>
						<th><br>Note : This is only needed when you Inventory sync is disabled.This will speed up the order sync process</th>
					</tr>
					<tr valign="top" class="">
						<th scope="row" class="titledesc">
							Enable Order Sync
...
echo 'checked'; } 
				...
				<tr>
				 ...
				 <?php if (!isset($options['ns_coupon_netsuite_sync'])) { ?>
					class="promo_required_fields"<?php } ?>
				 >
				<fieldset>
					<input  class="input-text" type="text" name="ns_promo_custform_id" id="ns_promo_custform_id" value="<?php isset($options['ns_promo_custform_id']) ? esc_attr_e($options['ns_promo_custform_id']) :  ''; ?>">
					<input  class="input-text" type="text" name="ns_promo_discount_id" id="ns_promo_discount_id" value="<?php isset($options['ns_promo_discount_id']) ? esc_attr_e($options['ns_promo_discount_id']) :  'NS Promo Discount ID'; ?>">
				</fieldset>
			</td>
		</tr>
		...
		<tr valign="top" class="">
			<th scope="row" class="titledesc">
				Enable Order Tracking email
				<div class="tooltip dashicons-before dashicons-editor-help">
					<span class="tooltiptext">Triggers email to customer whenver a order tracking no. is generated</span>
				</div>
			</th>
			<td class="forminp forminp-checkbox">
		...
		<tr valign="top" class="">
			<th scope="row" class="titledesc">
				Complete WC order when order fulfilled on NetSuite 
				<div class="tooltip dashicons-before dashicons-editor-help">
					<span class="tooltiptext">Mark WooCommerce order Complete when Order is Fulfilled on NetSuite</span>
				</div>
			</th>
			<td class="forminp forminp-checkbox">
