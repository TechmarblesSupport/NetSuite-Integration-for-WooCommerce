 ...
 */
	class WC_UPS_Order_TrackingNo_Email extends WC_Email {
		...
		public function __construct() {
			...
			$this->description = __( 'UPS order status notification emails will be sent to customer ', 'woocommerce' );

			// these are the default heading and subject lines that can be overridden using the settings
			$this->heading = 'UPS Order Tracking No.';
			$this->subject = 'UPS Order Tracking No.';
